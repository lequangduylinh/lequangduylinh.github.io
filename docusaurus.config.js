...
const config = {
  ...
  organizationName: 'lequangduylinh', // Usually your GitHub org/user name.
  projectName: 'lequangduylinh.github.io', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        //   },
        // ],
        copyright: `Copyright © ${new Date().getFullYear()} lequangduylinh. Built with Docusaurus.`,
      },
      prism: {
